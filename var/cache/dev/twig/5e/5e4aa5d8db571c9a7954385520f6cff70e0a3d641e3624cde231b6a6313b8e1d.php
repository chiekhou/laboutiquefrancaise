...
class __TwigTemplate_15c66a888db34e7192e0a5e2f3d97cd0cdf446cff9df2bbeee44051e4fcbfad7 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function getSourceContext()
    {
     ...
     <a href=\"{{ path('product',{'slug': product.slug} ) }}\"><img src=\"/uploads/{{ product.illustration }}\" alt=\"{{ product.name }}\" class=\"img-fluid\" width=\"200\" ></a>
     <h5>{{product.name}}</h5>
    <span class=\"product-subtitle\"> {{ product.subtitle }}</span>
    <span class=\"product-price\"> {{ (product.price / 100)|number_format(2, ',', '.') }} €</span>
</div>", "product/single_product.html.twig", "/Applications/MAMP/laboutiquefrancaise/templates/product/single_product.html.twig");
    }
}
