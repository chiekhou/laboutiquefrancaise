...
class __TwigTemplate_7388dab49fdada1ab359a147c14c7c16b8a263185bae65a30204beea622f07a9 extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    <button class=\"btn btn-lg btn-info btn-block mt-3\" type=\"submit\">
     ...
     <p class=\"text-center\"> Ou souhaitez-vous <a href=\"{{ path('register') }}\"> vous connectez ? <a/></p>
</form>
</div>
{% endblock %}
", "reset_password/index.html.twig", "/Applications/MAMP/laboutiquefrancaise/templates/reset_password/index.html.twig");
    }
}
