    ...
    public function index(Request $request): Response
    {
        ...
        if($request->get('email')) {
            ...
            if($user){
                ...
                // 2 : Envoyer un email à l'utilisateur avec un lien pour maj son mot de passe.
                ...
                $mail = new Mail();
                $mail->send($user->getEmail(), $user->getFirstname().' '.$user->getLastname(), 'Réintialiser votre mot de passe sur la Boutique Française', $content);
